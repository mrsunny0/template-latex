...
% include cannot go up parent directories because of .. notation
% however, paths relative to include are not considered, i.e. graphics etc.
% https://texfaq.org/FAQ-includeother
% https://tex.stackexchange.com/questions/15960/graphicspath-and-include
\includeonly{sections/section1,sections/section2}%,sections/section3}
